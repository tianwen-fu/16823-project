...
class RawData(object):
    ...
    pseudoData = property(_roypy.RawData_pseudoData_get, _roypy.RawData_pseudoData_set)
...
class IntermediateData(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    version = property(_roypy.IntermediateData_version_get, _roypy.IntermediateData_version_set)
...
class DepthData(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    version = property(_roypy.DepthData_version_get, _roypy.DepthData_version_set)
...
ProcessingFlag_AmplitudeThreshold_Float = _roypy.ProcessingFlag_AmplitudeThreshold_Float
ProcessingFlag_UseDotReProject_Bool = _roypy.ProcessingFlag_UseDotReProject_Bool
ProcessingFlag_UseMinimalPipeline_Bool = _roypy.ProcessingFlag_UseMinimalPipeline_Bool
ProcessingFlag_SpotSearchMinSnr_Float = _roypy.ProcessingFlag_SpotSearchMinSnr_Float
ProcessingFlag_WrappingThreshold_Float = _roypy.ProcessingFlag_WrappingThreshold_Float
ProcessingFlag_SpectreDebugMode_Int = _roypy.ProcessingFlag_SpectreDebugMode_Int
